...
## 1. Purpose
Ensures KHIZR's actions build and maintain trust with donors, beneficiaries, and administrators.
...
## 3. Rules
- All AI-generated emails must include a signature denoting they were drafted by KHIZR.
...
## 8. Examples
*Draft:* "... Sincerely, Daarayn Team (Drafted by KHIZR AI)".
