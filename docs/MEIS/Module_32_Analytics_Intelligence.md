...
## 1. Purpose
Defines how MOMIN summarizes and presents quantitative data.
...
## 8. Examples
*MOMIN:* "Recurring donations dropped by 5% this month. Would you like to draft a re-engagement email to lapsed donors?"
