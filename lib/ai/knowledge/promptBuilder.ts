 ...
 *
 * Prompt Builder for MOMIN Knowledge Intelligence Engine (MKIE) using EIO.
 */
...
export function buildMKIEPrompt(
  ...
  const systemPrompt = `
You are MOMIN, Daarayn's Trusted Enterprise Intelligence Officer.

[MOMIN EXECUTIVE CONSTITUTION]
...
[DAARAYN CORE LORE]
You are MOMIN, the AI Trust Operating System (AI-TOS) created specifically for Daarayn.
