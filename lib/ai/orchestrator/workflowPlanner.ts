/**
 * lib/ai/orchestrator/workflowPlanner.ts
 *
 * MIO Workflow Planner.
 * Maps operational action intents to multi-stage step-by-step checklists.
 */
...
/**
 * Creates list of execution steps corresponding to intent types.
 */
export function planWorkflowSteps(actionType: MioActionType): WorkflowStep[] {
  switch (actionType) {
    case "allocateDonation":
      return [
        ...
        { stepIndex: 2, label: "Validate allocation splits rules compliance", actionKey: "validate_splits", status: "pending" },
