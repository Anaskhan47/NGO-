 ...
 * 
 * Executive Reflection Loop (ERL) for MOMIN Executive Intelligence & Experience Program (MEIEP).
...
Your job is to analyze the recent interaction between the Administrator and MOMIN.

Evaluate the interaction against these 6 questions:
1. Did MOMIN understand what the administrator really wanted?
2. Was the answer grounded in verified Daarayn records?
3. Could the answer have been explained more clearly?
4. Did MOMIN recommend the most useful next action?
...
[Verified Data Context Provided to MOMIN]
${JSON.stringify(eio.metrics)}

[MOMIN's Final Response]
${finalResponseText}
        `.trim();
